$(document).ready(function() {
  setTimeout(function() {
    ...
    for (var o = 0; o < t.length; o++)
      t[o].selector &&
        (
          $(e.target).is(t[o].selector) && t[o].handler.call(e.target, e),
          $(e.target).parents(t[o].selector).each(function() {
    ...
    $(this).addClass(
      "is-active"
    ), $(".app-drawer-wrapper").addClass("drawer-open"), $(".app-drawer-overlay").removeClass("d-none");
  }), $(".drawer-nav-btn").click(function() {
    $(".app-drawer-wrapper").removeClass(
      "drawer-open"
    ), $(".app-drawer-overlay").addClass("d-none"), $(".open-right-drawer").removeClass("is-active");
  }), $(".app-drawer-overlay").click(function() {
    $(this).addClass(
      "d-none"
    ), $(".app-drawer-wrapper").removeClass("drawer-open"), $(".open-right-drawer").removeClass("is-active");
