    ...
    <div class="modal-body">
        ...
        <table class="table table-sm table-bordered table-striped">
            <tr>
                ...
                <td class="col-9">{{ $bidangKeahlian->bidang_keahlian_kode }}</td>
            </tr>
            <tr>
                <th class="text-right col-3">Nama Bidang Keahlian :</th>
                <td class="col-9">{{ $bidangKeahlian->bidang_keahlian_nama }}</td>
            </tr>
        </table>
        <form action="{{ url('/bidangKeahlian/' . $bidangKeahlian->bidang_keahlian_id) }}" method="POST" id="form-delete">
            @csrf
            @method('DELETE')
