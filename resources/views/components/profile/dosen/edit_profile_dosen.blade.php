<form id="form-edit-profile" action="{{ route('profile.dosen.update', auth()->user()->dosen->dosen_id) }}"
    ...
    <div class="text-center mt-n5">
        <img id="profileImage" class="rounded-circle border border-primary shadow bg-white img-thumbnail mb-3"
            ...
            src="{{ auth()->user()->dosen->foto_profile ? asset('storage/' . auth()->user()->dosen->foto_profile) : asset('assets/images/user.png') }}"
            alt="Profile picture">
        <div class="mt-2">
        ...
        <div class="row">
            <div class="mb-3 col-md-12">
                <div class="form-group">
                    <label>Nama</label>
                    <input value="{{ auth()->user()->dosen->user->nama }}" type="text" name="nama" id="nama"
